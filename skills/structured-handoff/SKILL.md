...
```
uv run ~/.config/devin/skills/structured-handoff/scripts/generate_handoff.py --task "TASK_DESCRIPTION" [--dir OUTPUT_DIR] [--num-tasks N]
```
...
2. Run the generate command:
   ```
   uv run ~/.config/devin/skills/structured-handoff/scripts/generate_handoff.py --task "USER_TASK" --dir ".tasks" --num-tasks 5
   ```
