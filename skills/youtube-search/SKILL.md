...
```
uv run ~/.config/cognition/skills/youtube-search/scripts/search_youtube.py <query> [options]
```
...
```
uv run ~/.config/cognition/skills/youtube-search/scripts/search_youtube.py <query>
```
...
```
uv run ~/.config/cognition/skills/youtube-wisdom/scripts/fetch_transcript.py "<video-url>"
```
